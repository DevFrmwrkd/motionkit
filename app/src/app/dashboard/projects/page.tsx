            ...
            <div className="space-y-4">
              {activeProject.presetEntries
                ...
                .map((entry) => {
                  ...
                  return (
                    <Card key={`${entry.presetId}-${entry.order}`} className="bg-card border-border">
                      <CardContent className="p-4 flex items-center justify-between gap-4">
                        <div className="min-w-0">
                          <p className="text-xs text-muted-foreground mb-1">Scene {entry.order + 1}</p>
                        ...
                        >
                          <Button className="bg-muted hover:bg-zinc-700 text-foreground">
                            Open
                          </Button>
                        </Link>
                      </CardContent>
        ...
        <>
          ...
          {projects === undefined ? (
            ...
            <div className="py-20 text-center space-y-3">
              ...
              <p className="text-sm text-muted-foreground">Create a project to organize your motion graphics</p>
            </div>
          ) : (
